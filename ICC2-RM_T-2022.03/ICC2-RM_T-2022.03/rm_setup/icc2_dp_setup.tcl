...
set INITIALIZE_FLOORPLAN_UTIL        "0.5" 
...
##########################################################################################
set DP_HIGH_CAPACITY_MODE "true" 
...
set INIT_DESIGN_DP_BLOCK_NAME "init_design_dp"          ;# Label name to be used when saving a block in rm_icc2_dp_flat_scripts/init_design_dp.tcl
set COMPILE_DP_BLOCK_NAME "compile_dp"                  ;# Label name to be used when saving a block in rm_icc2_dp_flat_scripts/compile_dp.tcl
set CREATE_FLOORPLAN_FLAT_BLOCK_NAME "create_floorplan" ;# Label name to be used when saving a block in rm_icc2_dp_flat_scripts/create_floorplan.tcl
set CREATE_POWER_FLAT_BLOCK_NAME "create_power"         ;# Label name to be used when saving a block in rm_icc2_dp_flat_scripts/create_power.tcl
set PLACE_PINS_FLAT_BLOCK_NAME "place_pins"             ;# Label name to be used when saving a block in rm_icc2_dp_flat_scripts/place_pins.tcl
