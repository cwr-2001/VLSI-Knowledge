...
==============================================================
* The files used in the IC Compiler II Flat Design Planning RM are as follows:
	- rm_setup/Makefile_dp_flat
	- rm_setup/icc2_dp_setup.tcl
	- rm_setup/design_setup.tcl
	- rm_icc2_dp_flat_scripts/init_design_dp.tcl
	- rm_icc2_dp_flat_scripts/create_floorplan.tcl
	- rm_icc2_dp_flat_scripts/create_power.tcl
	- rm_icc2_dp_flat_scripts/place_pins.tcl
