...
set REPORT_PREFIX ${EXPAND_OUTLINE_BLOCK_NAME}
...
if {$DP_HIGH_CAPACITY_MODE == "true"} {
  ...
  expand_outline
  eval load_block_constraints -type UPF -type CLKNET -blocks [get_blocks $all_blocks] ${HOST_OPTIONS}
} else {
