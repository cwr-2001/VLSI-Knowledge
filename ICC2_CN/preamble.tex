...
\hypersetup{
  ...
  pdftitle={IC Compiler II Implementation User Guide 中文学习译本},
  pdfauthor={Unofficial Study Translation}
}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small ICC2 Implementation UG V-2023.12}
...
\begin{center}
\small
原文版权归 Synopsys, Inc.\ 所有（Version V-2023.12, December 2023）。\\
