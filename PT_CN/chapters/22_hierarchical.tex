...
\hline
\tblhead{扁平全芯片分析} & \tblhead{HyperScale 层次化分析} \\
\hline
...
\begin{tabular}{|l|l|}
\hline
\tblhead{-include} & \tblhead{忽略的顶层 context 数据} \\
\hline
...
\hline
\tblhead{Point} & \tblhead{Mode} & \tblhead{Delay} & \tblhead{Weight} & \tblhead{Budget} \\
\hline
...
\hline
\tblhead{特性} & \tblhead{QTM} & \tblhead{ETM} \\
\hline
...
# ... report shows clock reconvergence pessimism and MIM pessimism ...
\end{lstlisting}
