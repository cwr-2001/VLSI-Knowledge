# -*- coding: utf-8 -*-
"""Generate A_deprecated.tex with proper UTF-8 encoding."""
from pathlib import Path
import re

OUT = Path(__file__).resolve().parent.parent / "chapters" / "A_deprecated.tex"

content = r"""% 附录 A Deprecated Features
