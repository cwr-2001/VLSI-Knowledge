# -*- coding: utf-8 -*-
"""Generate 04_performance_capacity.tex with proper UTF-8."""
from pathlib import Path

# Build chapter in parts for maintainability
PARTS = []

PARTS.append(r"""% 第 4 章 Managing Performance and Capacity
...
# Continue with more parts - I'll append DMSA batch, merged reporting, etc.
PARTS.append(r"""
...
text = "\n".join(PARTS)
out = Path(r"d:\IC Design\VLSI\PT_CN\chapters\04_performance_capacity.tex")
out.write_text(text, encoding="utf-8")
cjk = sum(1 for c in text if "\u4e00" <= c <= "\u9fff")
print(f"Wrote {out}")
print(f"bytes={out.stat().st_size} CJK={cjk}")
