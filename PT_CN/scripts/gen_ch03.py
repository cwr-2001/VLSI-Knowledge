# -*- coding: utf-8 -*-
"""Generate 03_licensing.tex with proper UTF-8."""
from pathlib import Path

text = r"""% 第 3 章 Licensing
...
out = Path(r"d:\IC Design\VLSI\PT_CN\chapters\03_licensing.tex")
out.write_text(text, encoding="utf-8")
print(f"Wrote {out} bytes={out.stat().st_size} CJK={sum(1 for c in text if chr(0x4e00)<=c<=chr(0x9fff))}")
