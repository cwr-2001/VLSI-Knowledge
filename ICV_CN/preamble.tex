...
\hypersetup{
  ...
  pdftitle={IC Validator User Guide 中文学习译本},
  pdfauthor={Unofficial Study Translation}
}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small IC Validator UG X-2025.06}
...
\begin{center}
\small
原文版权归 Synopsys, Inc.\ 所有（Version X-2025.06, June 2025）。\\
本文件为\textbf{非官方个人学习译本}，仅供学习参考，不得用于商业传播。\\
命令名、选项名、文件名、PXL 函数名等技术标识符保持英文原文不译。
\end{center}
}
