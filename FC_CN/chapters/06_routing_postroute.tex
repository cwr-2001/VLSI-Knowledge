...
本章介绍 Fusion Compiler 路由器 Zroute 的布线能力，以及布线后优化功能。Zroute 面向多核硬件架构，可高效处理 45~nm 及以下先进工艺设计规则与可制造性设计（DFM）任务。
...
\begin{itemize}
  ...
  \item \textbf{Block 要求}：
  \begin{itemize}
    \item 电源/地网络已在设计规划后、布局前布线完成（见 \textit{Fusion Compiler Design Planning User Guide}）；
...
布线定稿后：
\begin{lstlisting}
fc_shell> create_cut_metals
fc_shell> remove_cut_metals
\end{lstlisting}
