...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth,keepaspectratio]{figures/fig-verilog-select-op.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{figures/fig-qorsum-report.png}
\caption{QORsum 报告}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{figures/fig-comparison-report.png}
\caption{对比报告}
