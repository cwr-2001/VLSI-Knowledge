...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{figures/fig-fc-lib-analysis-flow.png}
\caption{库分析流程}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{figures/fig-fc-lib-monotonic.png}
\caption{库单元族中的单调分布}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{figures/fig-fc-lib-redundant.png}
\caption{库单元族中的冗余单元}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{figures/fig-fc-lib-outlier.png}
\caption{库单元族中的离群单元}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{figures/fig-fc-lib-equivalent.png}
\caption{库单元族中的等价单元}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{figures/fig-fc-lib-gap.png}
\caption{库单元族中的缺口}
...
\small
\begin{tabularx}{\textwidth}{@{}c >{\ttfamily\raggedright\arraybackslash}X >{\ttfamily\raggedright\arraybackslash}X l@{}}
\toprule
\textbf{列} & \textbf{\textrm{词法属性}} & \textbf{\textrm{允许模式}} & \textbf{示例单元取值} \\
\midrule
1 & lexical\_cell\_prefix\_name & {[a-zA-Z0-9]*} & \texttt{AND2} \\
2 & lexical\_drive1\_name & {D[0-9]*} & \texttt{D4} \\
3 & lexical\_well\_substrate\_bias\_architecure & WS & \texttt{WS} \\
4 & lexical\_device\_threshold\_voltage & ULVT | SVT | LVT | MVT & \texttt{ULVT} \\
\bottomrule
\end{tabularx}
\end{table}
