...
\toprule
\textbf{对象} & \textbf{类型} & \textbf{Level}（全部） & \textbf{Level}（工具插入） & \textbf{Stage}（全部） & \textbf{Stage}（工具插入） \\
\midrule
P1 & 已有时钟门控 & 1 & 0 & 4 & 2 \\
P2 & 已有时钟门控 & 2 & 0 & 3 & 2 \\
T1 & 工具插入时钟门控 & 3 & 1 & 2 & 2 \\
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.2cm}
\textit{（原书 Figure 50：Output of the report\_clock\_gating\_options Command）}
\vspace{1.2cm}}}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.2cm}
\textit{（原书 Figure 51：Command Output With no Options set to Specific Objects）}
\vspace{1.2cm}}}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.2cm}
\textit{（原书 Figure 52：Command Output With no Specific Object Options but Passed as Parameters）}
\vspace{1.2cm}}}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.2cm}
\textit{（原书 Figure 53：Command Output With the Same Option set to Multiple Objects）}
\vspace{1.2cm}}}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.2cm}
\textit{（原书 Figure 54：使用 -nosplit 参数时的命令输出）}
\vspace{1.2cm}}}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.5cm}
\textit{（原书 Figure 55：Clock Latency With Clock-Gating Design）}\\[0.3em]
\small Clock-Gating Cell / Register；Clock tree delay；lat\_reg、lat\_cgtoreg
\vspace{1.5cm}}}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.5cm}
\textit{（原书 Figure 56：Clock-Gating Stages and Latency Calculations）}
\vspace{1.5cm}}}
\caption{时钟门控阶段与延迟计算}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.5cm}
\textit{（原书 Figure 57：Latency Calculations With Varying Fanout）}
\vspace{1.5cm}}}
\caption{变化扇出下的延迟计算}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.5cm}
\textit{（原书 Figure 64：Example of a report\_clock\_gating Report）}
\vspace{1.5cm}}}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.2cm}
\textit{（原书 Figure 65：Example of a Multibit Composition Report）}
\vspace{1.2cm}}}
\caption{多比特组成报告示例}
...
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{1.5cm}
\textit{（原书示意：report\_clock\_gating\_efficiency 报告）}\\[0.3em]
\small Toggle Savings Distribution 直方图等列
\vspace{1.5cm}}}
